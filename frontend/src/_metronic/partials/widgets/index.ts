// you added these widgets aleyna
export * from './mixed/SizeOzel'
export * from './charts/SonHafta'
export * from './statistics/TahsilatOzet'
export * from './mixed/TahsilatMixed'
export * from './lists/KolayBirYol' 
export * from './lists/GunuGelen'
export * from './mixed/Mobil'
