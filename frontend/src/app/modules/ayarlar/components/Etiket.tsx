  ...
  return (
    <>
      <h3 className='fw-bolder my-2'>
        <span className='fs-6 text-gray-500 fw-bold ms-1'>Etiket</span>
      </h3>
          ...
          <div className="col-md-4">
            ...
            <div className="card card-flush h-md-100">
              ...
              <div className="card-footer flex-wrap pt-0">
                <button type="button" className="btn btn-light btn-active-light-primary my-1" data-bs-toggle="modal" data-bs-target="#kt_modal_update_role">Yeni Etiket Ekle</button>
              </div>
              {/* end::Card footer */}
            </div>
            {/* end::Card */}
            ...
            <div className="card h-md-100">
              ...
              <div className="card-body d-flex flex-center">
                ...
                <button type="button" className="btn btn-clear d-flex flex-column flex-center" data-bs-toggle="modal" data-bs-target="#kt_modal_add_role">
                  ...
                  {/* end::Illustration */}
                  {/* begin::Label */}
                  <div className="fw-bold fs-3 text-gray-600 text-hover-primary">Yeni Etiket Ekle</div>
                  {/* end::Label */}
                </button>
                {/* begin::Button */}
              </div>
